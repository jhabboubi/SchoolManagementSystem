...
public class SMSRunner {
	...
	// crate two static object if StudentService and CourseService to use their
	// methods easier
	static StudentService s = new StudentService();
	static CourseService c = new CourseService();
			...
			case 3:
				...
				if (s.validateStudent(sEmail, sPass)) {
					...
					case 1:
						...
						System.out.println("Student " + sEmail.split("@") + " Courses");
